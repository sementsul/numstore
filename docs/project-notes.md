...
- `collect_catalog.py` — тянет до 250 номеров/категория из API → `data/catalog.json` (поля n/t/p). Запускать в CI (у контейнера IP к API в бане, у GH Actions — проходит).
