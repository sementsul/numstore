...
## Статус
v3: маркетплейс-раскладка (сайдбар-фильтры категория/цена/тариф + густая сетка + «показать ещё»); дефолт грузит широкий пул phone_pattern=9NNNNNNNNN. Ранее — поиск по маске (cubes) с живой подгрузкой из API + генерация/копирование реф-ссылки + дефолтный
