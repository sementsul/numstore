...
Дальше: страницы паттернов (зеркальные/повторы/…), калькулятор «сколько стоит номер» (красота+регион),
тарифные страницы, гайды/блог, деплой на GitHub Pages. Позже: авто-извлечение токена на сборке.
