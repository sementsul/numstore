...
def render_calc():
    ...
    body = (
        ...
        '<a href="https://bezlimit.ru/files/" target="_blank" rel="noopener">bezlimit.ru/files</a>. '
...
def render_about():
    body = (
        ...
        'оператора: <a href="https://bezlimit.ru/files/" target="_blank" rel="noopener">bezlimit.ru/files</a>.</p>'
