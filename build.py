...
CITIES = [
    ...
    },
    {
        ...
        "desc": "Красивые и премиальные номера в Санкт-Петербурге: бриллиантовые, платиновые, золотые. "
                "Бесплатная доставка SIM по Петербургу и области или eSIM за минуты. Бронь онлайн.",
        "intro": "Премиальные номера с доставкой по Санкт-Петербургу и Ленинградской области. Соберите "
                 "комбинацию маской или выберите категорию — бронь онлайн.",
        "text": "<h2>Красивый номер в Петербурге</h2>"
                "<p>В деловом Петербурге красивый номер — это статус и удобство: его легко продиктовать "
                "партнёру и приятно подарить. В каталоге — бриллиантовые, платиновые, золотые, серебряные "
                "и бронзовые комбинации: зеркальные, парные, с круглым окончанием.</p>"
                "<h2>Доставка по городу и области</h2>"
                "<p>SIM привезём по Санкт-Петербургу и Ленинградской области бесплатно или оформим eSIM "
                "за минуты, без визита в офис. Номер федеральный — работает по всей России.</p>"
                "<h2>Как выбрать</h2>"
                "<p>Впишите в маску важные цифры, остальное оставьте пустым. Или сузьте выдачу по коду "
                "в списке над каталогом.</p>",
    },
    {
        ...
        "desc": "Красивые и премиальные номера в Краснодаре: бриллиантовые, платиновые, золотые. "
                "Бесплатная доставка SIM по Краснодару и краю или eSIM. Бронирование онлайн.",
        "intro": "Премиальные номера с доставкой по Краснодару и краю. Соберите комбинацию маской или "
                 "выберите категорию — бронь онлайн за пару минут.",
        "text": "<h2>Красивый номер в Краснодаре</h2>"
                "<p>Краснодар — деловая столица Юга, и красивый номер здесь работает как визитка: его "
                "проще запомнить, легче продиктовать, приятно подарить. В каталоге — бриллиантовые, "
                "платиновые, золотые, серебряные и бронзовые комбинации.</p>"
                "<h2>Доставка по краю</h2>"
                "<p>SIM привезём по Краснодару и Краснодарскому краю бесплатно или оформим eSIM за минуты. "
                "Номер федеральный — работает по всей России.</p>"
                "<h2>Как выбрать</h2>"
                "<p>Впишите в маску важные цифры, остальное оставьте пустым — покажем подходящие. Или "
                "отфильтруйте по коду в списке над каталогом.</p>",
    },
    {
        ...
        "desc": "Красивые и премиальные номера в Сочи: бриллиантовые, платиновые, золотые. Бесплатная "
                "доставка SIM по Сочи или eSIM за минуты. Бронирование онлайн.",
        "intro": "Премиальные номера с доставкой по Сочи. Соберите комбинацию маской или выберите "
                 "категорию — бронь онлайн.",
        "text": "<h2>Красивый номер в Сочи</h2>"
                "<p>Сочи — курортная столица, город бизнеса и отдыха, где красивый номер особенно "
                "уместен: как статусная деталь и как подарок. В каталоге — бриллиантовые, платиновые, "
                "золотые, серебряные и бронзовые комбинации.</p>"
                "<h2>Доставка</h2>"
                "<p>SIM привезём по Сочи бесплатно или оформим eSIM за минуты. Номер федеральный — "
                "работает по всей России, что удобно в поездках.</p>"
                "<h2>Как выбрать</h2>"
                "<p>Впишите в маску важные цифры, остальное оставьте пустым. Или сузьте выдачу по коду "
                "над каталогом.</p>",
    },
    {
        ...
        "desc": "Красивые и премиальные номера в Ростове-на-Дону: бриллиантовые, платиновые, золотые. "
                "Бесплатная доставка SIM по Ростову и области или eSIM. Бронь онлайн.",
        "intro": "Премиальные номера с доставкой по Ростову-на-Дону и области. Соберите комбинацию "
                 "маской или выберите категорию — бронь онлайн.",
        "text": "<h2>Красивый номер в Ростове</h2>"
                "<p>В Ростове-на-Дону красивый номер — это удобство и статус: его легко продиктовать и "
                "приятно подарить. В каталоге — бриллиантовые, платиновые, золотые, серебряные и "
                "бронзовые комбинации.</p>"
                "<h2>Доставка по области</h2>"
                "<p>SIM привезём по Ростову-на-Дону и Ростовской области бесплатно или оформим eSIM за "
                "минуты. Номер федеральный — работает по всей России.</p>"
                "<h2>Как выбрать</h2>"
                "<p>Впишите в маску важные цифры, остальное оставьте пустым. Или сузьте выдачу по коду "
                "над каталогом.</p>",
    },
    {
        ...
        "desc": "Красивые и премиальные номера в Грозном и Чечне: бриллиантовые, платиновые, золотые. "
                "Бесплатная доставка SIM по Чечне или eSIM. Бронирование онлайн.",
        "intro": "Премиальные номера с доставкой по Грозному и Чеченской Республике. Соберите комбинацию "
                 "маской или выберите категорию — бронь онлайн.",
        "text": "<h2>Красивый номер в Грозном</h2>"
                "<p>Красивый номер — это статус и хороший подарок, который запоминают. В каталоге "
                "MagzGold — бриллиантовые, платиновые, золотые, серебряные и бронзовые комбинации: "
                "зеркальные, парные, с повторами и круглыми окончаниями.</p>"
                "<h2>Доставка по Чечне</h2>"
                "<p>SIM привезём по Грозному и Чеченской Республике бесплатно или оформим eSIM за минуты. "
                "Номер федеральный — работает по всей России.</p>"
                "<h2>Как выбрать</h2>"
                "<p>Впишите в маску важные цифры, остальное оставьте пустым. Или сузьте выдачу по коду "
                "над каталогом.</p>",
    },
    {
        ...
        "desc": "Красивые и премиальные номера в Махачкале и Дагестане: бриллиантовые, платиновые, "
                "золотые. Бесплатная доставка SIM по Дагестану или eSIM. Бронирование онлайн.",
        "intro": "Премиальные номера с доставкой по Махачкале и Республике Дагестан. Соберите комбинацию "
                 "маской или выберите категорию — бронь онлайн.",
        "text": "<h2>Красивый номер в Махачкале</h2>"
                "<p>Красивый номер — это статус и достойный подарок. В каталоге MagzGold — бриллиантовые, "
                "платиновые, золотые, серебряные и бронзовые комбинации: зеркальные, парные, с повторами "
                "и круглыми окончаниями.</p>"
                "<h2>Доставка по Дагестану</h2>"
                "<p>SIM привезём по Махачкале и Республике Дагестан бесплатно или оформим eSIM за минуты. "
                "Номер федеральный — работает по всей России.</p>"
                "<h2>Как выбрать</h2>"
                "<p>Впишите в маску важные цифры, остальное оставьте пустым. Или сузьте выдачу по коду "
                "над каталогом.</p>",
